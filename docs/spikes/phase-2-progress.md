...
| A2 | Flowchart / architecture-C4 / dependency via ELK | ⏳ next | — | — | needs ELK adapter + measurement + SVG renderer |
| A12 | Swimlane LTR (ref-1 + ref-3) | ⬜ | — | — | lane-grid path (Phase-0 decision); reuse spike-3 |
